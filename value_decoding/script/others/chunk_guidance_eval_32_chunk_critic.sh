...
CRITIC_CHECKPOINT_DIR="/data/shuozhe/verl/train_log/job_ds_1d5b_chunk_boundary_critic/global_step_700"

# --- Data ---------------------------------------------------------------------
DATASET_PATH="/data/shuozhe/saved_dataset/MetaMathQA-math-500/test.parquet"
OUTPUT_DIR="/data/shuozhe/verl/value_decoding/output/chunk_guidance_eval_32_k2_4_8_ds_1d5_chunk_critic_bce_gs700"
PROMPT_KEY="prompt"
...
# NUM_CHUNK_CANDIDATES_VALUES="12 16 32"
BETAS="0"
VALUE_REDUCERS="end"       # Keep "end" for the chunk-boundary critic; "mean" would average unsupervised interior states.
