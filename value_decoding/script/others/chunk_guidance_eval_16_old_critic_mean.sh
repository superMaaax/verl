...
OUTPUT_DIR="/data/shuozhe/verl/value_decoding/output/chunk_guidance_eval_16_old_critic_mean_k_2_4_8"
PROMPT_KEY="prompt"
...
BETAS="0"
VALUE_REDUCERS="mean"       # Add "mean" for the ablation.
INCLUDE_CRITIC_ONLY=1      # 1 = add optional critic-only chunk rerank configs
SKIP_ACTOR_ONLY_BASELINES=1  # 1 = skip ordinary actor-only and chunk actor-only baselines
