#!/bin/bash
#SBATCH --job-name=PRM_chunk_256_7B
...
CRITIC_CHECKPOINT_DIR="/work2/09576/shuozhe/saved_model/Qwen2.5-Math-PRM-7B"
...
OUTPUT_DIR="${RUN_DIR}/PRM_7b_seed_42"
